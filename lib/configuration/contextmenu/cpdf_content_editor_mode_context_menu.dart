...
class CPDFContentEditorModeContextMenu {
  final List<CPDFContextMenuItem<CPDFContentEditorEditTextAreaMenuKey>>
      editTextArea;
  final List<CPDFContextMenuItem<CPDFContentEditorEditSelectTextMenuKey>>
      editSelectText;
  ...
  final List<CPDFContextMenuItem<CPDFContentEditorImageCropMenuKey>>
      imageCropMode;
  final List<CPDFContextMenuItem<CPDFContentEditorEditPathMenuKey>>
      editPathContent;
  final List<
          CPDFContextMenuItem<
  ...
  final List<
          CPDFContextMenuItem<
              CPDFContentEditorLongPressWithEditImageModeMenuKey>>
      longPressWithEditImageMode;
  final List<CPDFContextMenuItem<CPDFContentEditorLongPressWithAllModeMenuKey>>
      longPressWithAllMode;
  final List<CPDFContextMenuItem<CPDFContentEditorSearchReplaceMenuKey>>
      searchReplace;
  ...
  const CPDFContentEditorModeContextMenu({
    ...
    this.editSelectText = const [
      ...
      CPDFContextMenuItem(CPDFContentEditorEditSelectTextMenuKey.opacity,
          subItems: [
    ...
    this.longPressWithEditTextMode = const [
      ...
      CPDFContextMenuItem(CPDFContentEditorLongPressWithEditTextModeMenuKey
    ...
    this.longPressWithAllMode = const [
      ...
      CPDFContextMenuItem(CPDFContentEditorLongPressWithAllModeMenuKey
          .keepSourceFormatingPaste),
    ],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'editSelectTextContent':
          editSelectText.map((item) => item.toJson()).toList(),
      ...
      'longPressWithEditTextMode':
          longPressWithEditTextMode.map((item) => item.toJson()).toList(),
      'longPressWithEditImageMode':
          longPressWithEditImageMode.map((item) => item.toJson()).toList(),
      'longPressWithAllMode':
          longPressWithAllMode.map((item) => item.toJson()).toList(),
